...
| 職位 | 姓名 | 學號 | 負責任務 |
| :------- | :--------: | :--------: |--------: |
| 組長 | 江浩賢 | B110118302 |功能性需求及非功能性需求、分鏡板、Figma、UML類別圖、DFD、DFD0
| 組員 | 謝秉諭 | C108118185 |使用案例說明、循序圖、PERT/CPM、DFD、DFD0
| 組員 | 林育賢 | C109118134 |活動圖、FDD、DFD、DFD0
| 組員 | 杜佳原 | C109118114 |實體關係圖、DFD、DFD0


# 內容：
>描述內容

SportGo是一款主打move-to-earn靠運動或是走路來賺取軟體積分的APP，那透過記錄運動所獲取的積分可以拿來兌換商品區及折扣，目的是希望可以給予民眾去運動的動機，保持健康的體態。
